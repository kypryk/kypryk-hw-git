...
//без оператора НЕ !
const checkPrice2 = (price) => {
    if(price < 1000 || price > 1900){
        console.log(`${price} is outside of the the 1000-1900 range`);
    }else{
        console.log(`${price} is within the the 1000-1900 range`);
    }
}
checkPrice2(1000)
...
function checkPrice3(price){
    !(price >= 1000 && price <= 1900) ? console.log(price + ' is outside of the the 1000-1900 range') : console.log(price + ' is within the the 1000-1900 range');
}
checkPrice3(999)
...
const seasonChecker = function(season){
    if(season == 1){
...
const dummyCalculator = function(number1, number2, operator){
    switch(operator){
        case '+':
...
vowelRemover("Orcs must die, something else, test, test")
